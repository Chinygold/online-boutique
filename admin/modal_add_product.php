<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                              ...
                              <form  method="post" enctype="multipart/form-data">
                                ...
                                <div class="control-group">
                                    <label class="control-label" for="inputPassword">Price (GH¢):</label>
                                    <div class="controls">
...
//
                                ...
                                mysqli_query("insert into tb_products (name,description,category,originated,price,quantity,location)
