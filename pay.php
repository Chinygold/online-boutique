                    ...
                    <div id="body">
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr"  method="post">
                           ...
                           <?php } ?>
                            ...
                            <input type="image" src="mtn.jpg" border="0" name="submit" alt="Make payments with mobile money - it's fast, free and secure!" style="margin-left: 280px;" class="img-rounded" />
							 <p>THERE IS CURRENTLY ONE OPTION AVAILABLE FOR YOU TO MAKE PAYMENT FOR YOUR ORDERS.</p>

<p><strong>PAYMENT IDENTIFICATION</strong><BR></p>

<p>IF YOU USE MTN MOBILE MONEY, PLEASE SEND US THE NAME OF MERCHANT OR NAME ON THE SENDER'S NUMBER AND/OR TRANSACTIONID NUMBER AFTER MAKING PAYMENT SO THAT WE CAN IDENTIFY YOUR PAYMENT WITH YOUR ORDER.
 <BR></p>


<p><strong>MOBILE MONEY</strong></p>

<p>Send to MTN NUMBER:<strong> 0245 753 659 &nbsp;&nbsp;&nbsp; (REGISTERED SUBSCRIBER)</strong>
 <br><br></p>

<p><br/><br/></p>

                            <img alt="fdff" border="0" src="mtn.jpg" width="1" height="1" />
                            <!-- Payment confirmed -->
