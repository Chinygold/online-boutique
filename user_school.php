                ...
                <div class="hero-unit-table"> 
                    ...
                    <div id="body">
                        ...
                        <ul class="thumbnails">
                            ...
                            $query = mysqli_query($conn,"select * from tb_products WHERE category = 'School'") or die(mysqli_error());
                            while ($row = mysqli_fetch_array($query)) {
                                ...
                                <li class="span3">
                                    ...
                                    if (isset($_POST['order'])) {
                                        ...
                                        mysqli_query("insert into order_details (memberID,qty,productID,price,total,status) values('$member_id','$quantity','$product_id','$price','$total','Pending')") or die(mysql_query);
